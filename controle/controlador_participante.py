...
class ControladorParticipante: 
    ...
    def abre_tela(self):
        ...
        continua = True
        while continua:
            lista_opcoes[self.__tela_participante.tela_opçoes()]()
    ...
    def exclui_participante(self):
        ...
        if len(self.__participantes) < 1:
            ...
            codigo_participante = self.__tela_participante.pega_participante_codigo()
    ...
    def lista_um_participante(self):
        if len(self.__participantes) < 1: 
            ...
            #codigo_participante = self.__tela_participante.pega_participante_codigo
            participante = self.__tela_participante.pega_participante_codigo()
            if participante is not None: 
                ...
                self.__tela_participante.mostra_participante('Participante inexistente!')
    ...
    def lista_participantes(self):
        if len(self.__participantes) < 1: 
            ...
            for participante in self.__participantes:
                 self.__tela_participante.mostra_participante({"nome": participante.nome, "cpf": participante.cpf, "endereço": participante.endereço, "idade": participante.idade, "vacina": participante.vacina_3d, "PCR": participante.exame_pcr, "código": participante.codigo})
